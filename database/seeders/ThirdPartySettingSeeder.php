...
//sms
    ...
    //sms_south_africa
        //sms south africa
        ['name' => 'enable_sms_south_africa',
         'value' => '0',
         'module' => 'sms',
        ], 
        ['name' => 'sms_south_africa_api_key',
         'value' => 'Your SMS South Africa API Key',
         'module' => 'sms',
        ],  
        ['name' => 'sms_south_africa_api_secret',
         'value' => 'Your SMS South Africa API Secret',
         'module' => 'sms',
        ], 
        ['name' => 'sms_south_africa_sender_id',
         'value' => 'Your SMS South Africa Sender ID',
         'module' => 'sms',
        ], 
   // sparrow               
        ['name' => 'enable_sparrow',
