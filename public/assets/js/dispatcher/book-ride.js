...
$(document).on('change', '#goods_quantity_no',function(){
  ...
  $(document).change('date_picker', function(e){
                ...
                if(type != 'stop') {
                    ...
                    result.suggestions
                        ...
                        .map((suggestion) => ({
                            ...
                            HTML+= `<div id=${item.placeId} class="autocomplete-item" onClick="selectSuggestion(this,'${type}')">${item.formattedAddress}</div>`;
                        });
                    ...
                    result.suggestions
                        ...
                        .map((suggestion) => ({
                            ...
                            HTML+= `<div id=${item.placeId} class="autocomplete-item" onClick="selectSuggestion(this,'${type}','${index}')">${item.formattedAddress}</div>`;
                        });
    ...
    function selectSuggestion(element,type,index=null) {
        ...
        $.ajax({
            ...
            {
                const formattedAddress = $(element).text();
                if(type!= 'stop'){
                ...
                if(type == 'pick') {
                    ...
                    bindDataToForm(formattedAddress, pickUpLat, pickUpLng, 'pickup');
                 ...
                 if(pickUpLocation && dropLocation) {
                    ...
                    bindDataToForm(formattedAddress, dropLat, dropLng, 'drop');
                }
            },
            error: function(error)
            {
