                ...
                <div class="col-sm-12">
                    <div class="box">
                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" class="form-horizontal" action="{{ url('country/store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div id="{{$v->locale}}" class="tab-pane p-3 show lang_data_show active show_en">
                                        ...
                                        <input  id="name_{{$v->locale}}" name="name_{{$v->locale}}" value="" type="text" class="form-control w-full en_cate_name" placeholder="@lang('view_pages.enter') @lang('view_pages.name')" style="padding: 15px;">
                                    </div>
                                    @else
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" id="dial_min_length" name="dial_min_length"
                                                value="{{ old('dial_min_length') }}" required
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" id="dial_max_length" name="dial_max_length"
                                                value="{{ old('dial_max_length') }}" required=""
