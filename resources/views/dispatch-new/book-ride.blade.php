                      ...
                      <div class="textOnInput mt-5">
                          <label for="pickup" class="form-label">Pickup</label>
                            ...
                            <div class="autocomplete-container">
                                ...
                                <input id="pick-input" class="form-control controls" onInput="handleInput('pick')" type="text" placeholder="@lang('view_pages.search')" />
                      ...
                      <div class="textOnInput mt-10">
                          <label for="drop" class="form-label">Drop</label>
                            ...
                            <div class="autocomplete-container">
                                ...
                                <input id="drop-input" class="form-control controls" onInput="handleInput('drop')" type="text" placeholder="@lang('view_pages.search')" />
