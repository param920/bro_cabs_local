...
@if($data->requestBill->additional_charges_amount > 0)
<!-- Ride fare -->
<tr>
<td
style="color: #ffffff; line-height: 8px !important; padding: 0 0 0 0; font-size: 13px">
...
line-height: 18px;
">
Additional Charges<br> ({{$data->requestBill->additional_charges_reason}})
</td>
</tr>
</tbody>
</table>
...
">
{{ $data->currency }}
{{ number_format($data->requestBill->additional_charges_amount, 2) }}
</td>
</tr>
</tbody>
</table>
